...
;;;; +------------+
  (custom-theme-set-faces
    ...
    `(font-lock-builtin-face ((,class (:inherit italic :foreground ,nord9))))
    `(font-lock-comment-face ((,class (:inherit italic :foreground ,nord-comment))))
    `(font-lock-comment-delimiter-face ((,class (:foreground ,nord-comment))))
    `(font-lock-constant-face ((,class (:inherit italic :foreground ,nord9))))
    `(font-lock-doc-face ((,class (:foreground ,nord-comment))))
    `(font-lock-function-name-face ((,class (:foreground ,nord8))))
    `(font-lock-keyword-face ((,class (:inherit italic :foreground ,nord9))))
    ...
    `(font-lock-negation-char-face ((t (:inherit 'bold :foreground ,nord9))))
